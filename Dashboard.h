...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(954, 103);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Welcome to the Dashboard";
			this->label1->TextAlign = System::Drawing::ContentAlignment::TopCenter;
			// 
			// lbUserInfo
			// 
			this->lbUserInfo->AutoSize = true;
			this->lbUserInfo->Location = System::Drawing::Point(74, 197);
			this->lbUserInfo->Margin = System::Windows::Forms::Padding(5, 0, 5, 0);
			this->lbUserInfo->Name = L"lbUserInfo";
			this->lbUserInfo->Size = System::Drawing::Size(118, 52);
			...
			this->ClientSize = System::Drawing::Size(1060, 1783);
